...
<body class="">
    ...
    <main class="main-content  mt-0">
        <section>
            <div class="page-header min-vh-100" style="background-color: #979797;">
                <div class="container">
                    <div class="row">
                        ...
                        <div
                            ...
                            <div
                                class="position-relative h-100 m-3 px-7 border-radius-lg d-flex flex-column overflow-hidden" style="background-color: #979797;">
